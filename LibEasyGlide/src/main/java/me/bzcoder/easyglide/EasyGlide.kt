...
object EasyGlide {
    ...
    @JvmOverloads
    fun ImageView.loadImage(context: Context, url: Any?, @DrawableRes placeHolder: Int = placeHolderImageView, onProgressListener: OnProgressListener? = null, requestListener: RequestListener<Drawable?>? = null) {
        loadImage(context,
                GlideConfigImpl
                        .builder()
                        .url(url)
     ...
     */
    @JvmOverloads
    fun ImageView.loadResizeXYImage(context: Context, url: Any?, resizeX: Int, resizeY: Int, @DrawableRes placeHolder: Int = placeHolderImageView) {
        loadImage(context,
                GlideConfigImpl
                        .builder()
                        .url(url)
    ...
    @JvmOverloads
    fun ImageView.loadCircleImage(context: Context, url: Any?, @DrawableRes placeHolder: Int = circlePlaceholderImageView) {
        loadImage(context,
                GlideConfigImpl
                        .builder()
                        .url(url)
    ...
    @JvmOverloads
    fun ImageView.loadGrayImage(context: Context, url: Any?, @DrawableRes placeHolder: Int = placeHolderImageView) {
        loadImage(context,
                GlideConfigImpl
                        .builder()
                        .url(url)
    ...
    @JvmOverloads
    fun ImageView.loadBlurImage(context: Context, url: Any?, radius: Int = 10, @DrawableRes placeHolder: Int = placeHolderImageView) {
        loadImage(context,
                GlideConfigImpl
                        .builder()
                        .url(url)
    ...
    @JvmOverloads
    fun ImageView.loadRoundCornerImage(context: Context, url: Any?, radius: Int = 40, margin: Int = 0, @DrawableRes placeHolder: Int = placeHolderImageView) {
        loadImage(context,
                GlideConfigImpl
                        .builder()
                        .url(url)
    ...
    @JvmOverloads
    fun ImageView.loadCircleWithBorderImage(context: Context, url: Any?, borderWidth: Int = 2, @ColorInt borderColor: Int = 0xACACAC, @DrawableRes placeHolder: Int = placeHolderImageView) {
        loadImage(context,
                GlideConfigImpl
                        .builder()
                        .url(url)
    ...
    @JvmOverloads
    fun ImageView.loadBorderImage(context: Context, url: Any?, borderWidth: Int = 2, @ColorInt borderColor: Int = 0xACACAC, @DrawableRes placeHolder: Int = placeHolderImageView) {
        loadImage(context,
                GlideConfigImpl
                        .builder()
                        .url(url)
     ...
     * CenterCrop
     */
    fun ImageView.loadImageWithTransformation(context: Context, url: Any?, vararg bitmapTransformations: BitmapTransformation, @DrawableRes placeHolder: Int = placeHolderImageView) {
        loadImage(context,
                GlideConfigImpl
                        .builder()
                        .url(url)
    ...
    fun loadImage(context: Context, config: GlideConfigImpl) {
        ...
        glideRequest.apply {
            ...
            into(GlideImageViewTarget(config.imageView, config.url.toString()))
        }

        if (config.onProgressListener != null && !config.url.toString().isNullOrBlank()) {
            ProgressManager.addListener(config.url!!.toString(), config.onProgressListener)
        }
